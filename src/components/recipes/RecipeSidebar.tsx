...
export default function RecipeSidebar({
  ...
  return (
    <aside className='w-64 shrink-0 rounded-xl border border-gray-200 bg-white p-4 shadow-sm'>
              ...
              <button
                className={`w-full rounded-md px-2 py-1 text-left text-sm ${
                  category === cat
                    ...
                    : 'hover:bg-gray-100:bg-gray-700 text-gray-800'
                }`}
      ...
      <button
        className='hover:bg-gray-300:bg-gray-600 w-full rounded-md bg-gray-200 px-2 py-1 text-sm font-medium text-gray-800'
        onClick={() => {
          setCategory(null);
          setDifficulty(null);
        }}
